...
if __name__ == '__main__':
    clinton = 'http://www.presidency.ucsb.edu/2016_election_speeches.php?candidate=70&campaign=2016CLINTON&doctype=5000'
    ...
    n = 3.
    csvfile =  open(os.path.join(os.path.pardir,'data','speeches.csv'), 'wb')
